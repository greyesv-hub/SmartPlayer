...
public class EstadisticasMusical {
    ...
    public String getReporteCompleto() {
        ...
        long tamDup = 0;
        for (Cancion[] par : duplicados) {
            tamDup += par[1].getTamano();
        }
    ...
    public long getUltimaBusquedaABB() {
        return ultimaBusquedaABB;
    }

    public long getUltimaBusquedaAVL() {
        return ultimaBusquedaAVL;
    }
}
