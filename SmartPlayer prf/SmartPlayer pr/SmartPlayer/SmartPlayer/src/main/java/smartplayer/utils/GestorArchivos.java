...
public class GestorArchivos {
    ...
    public static Playlist importarPlaylistEncriptada(String rutaArchivo, Playlist referencia, EncriptadorPlaylist.TipoRecorrido recorrido) {
        try {
            String contenido = Files.readString(Paths.get(rutaArchivo));
            return EncriptadorPlaylist.desencriptarArchivo(contenido, referencia, recorrido);
