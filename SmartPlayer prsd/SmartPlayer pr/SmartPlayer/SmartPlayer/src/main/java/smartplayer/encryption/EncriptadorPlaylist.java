...
public class EncriptadorPlaylist {
    ...
    StringBuilder sb = new StringBuilder();
     ...
     for (String linea : lineas) {
      ...
      public static Playlist desencriptarArchivo(String contenidoCifrado, Playlist referencia, TipoRecorrido recorrido) {
       ...
       TipoRecorrido rec = TipoRecorrido.IN_ORDEN;
        ...
        if (!encabezado.contains(recorrido.name())) {
            return null;
        }
       String plano = desencriptar(cifrado, referencia,recorrido);
